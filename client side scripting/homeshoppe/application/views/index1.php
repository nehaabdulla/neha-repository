...
<link href="<? echo base_url() ?>css/slider.css" rel="stylesheet" type="text/css" media="all"/>
<script type="text/javascript" src="<? echo base_url() ?>js/jquery-1.7.2.min.js"></script> 
<script type="text/javascript" src="<? echo base_url() ?>js/move-top.js"></script>
<script type="text/javascript" src="<? echo base_url() ?>js/easing.js"></script>
<script type="text/javascript" src="<? echo base_url() ?>js/startstop-slider.js"></script>
    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="preview1.html"><img src="images/feature-pic2.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>
					<div class="price-details">
				       <div class="price-number">
