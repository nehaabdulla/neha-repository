...
function fun4()
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/viewproducts",
		'datatype':"json",
		'data':{name:vall},
		'success':function(data){
...
function fun3(){
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/viewtblpro",
		'datatype':"json",
		'data':{name:val},
		'success':function(data){
...
function edit(btnpro)
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/productsedit",
		'datatype':"json",
		'data':{name:btnpro },
		'success':function(data){
			$('#div2').show();
...
function del(btndel)
{
		$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/delproduct",
		'data':{name:btndel},
		'success':function(data){	
		if(data=="YES"){
			alert("error");
...
<div class="header_slide">
	<div class="header_bottom_left">				
		...
		<div class="container" style="padding:15px;" id="div2">
	  	     <div class="row">
	  	     	<div class="col-sm-offset-3 col-sm-5">
            		<div class="panel panel-default">
 ...
 <div class="main">
    <div class="content">
    	<div class="content_top" style="margin-top:750px;">
    		<div class="heading">
    		<h3>New Products</h3>
    		</div>
    		<div class="see">
