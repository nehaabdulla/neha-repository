...
function fun1()
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/subcop",
		'datatype':"json",
		'data':{name:vall},
		'success':function(data){
			...
			// 	// alert(index);
			// 	// alert(value);
			// 	  $('#sub1').append($('<option>').text(value).attr('value',value));
			// });
			// if(data){
			// 	alert(data);
   //              //$('#spc').innerHTML=data;
...
<div class="header_slide">
	  	     			...
	  	     			<div class="col-sm-offset-3 col-sm-5">
            				<div class="panel panel-default">
                				<div class="panel-heading">
                					<span class="glyphicon glyphicon-list-alt"><b> Products</b></span> 
                   				</div>
 ...
 <div class="main">
    <div class="content">
    	<div class="content_top" style="margin-top:600px;">
    		<div class="heading">
    		<h3>New Products</h3>
    		</div>
    		<div class="see">
