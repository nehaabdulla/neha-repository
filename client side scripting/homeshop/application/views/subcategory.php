		...
		<div class="categories">
	  	     			...
	  	     			<div class="col-sm-offset-1 col-sm-5">
            				<div class="panel panel-default">
                				<div class="panel-heading">
                					<span class="glyphicon glyphicon-list-alt"><b> Sub-Category</b></span> 
                   				</div>
                   				<div class="panel-body">
                   					<form class="form-horizontal" role="form" name="" action ="selectcategory" method="post">
                   						<div class="form-group">
                        					...
                        					<div class="col-sm-7">
                        					<select name="fk_int_cat_id"><option>select category</option><?php
			...
			<table>
				<tr>
					...
					<td><select name="fk_int_cat_id"><?php
					foreach($category as $row)
					{
						echo '<option value="'.$row->pk_int_cat_id.'">'.$row->vchr_cat_name.'</option>';
					}
				...
				<tr>
					...
					<td><input type="text" placeholder="Enter sub-category name" name="subcat"></td>
				</tr>
				<tr>
