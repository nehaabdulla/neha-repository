...
function edit(btnvalue)
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/edit",
		'datatype':"json",
		'data':{name:btnvalue},
		'success':function(data){
			$('#id1').empty();
...
function del(btnvalue)
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/delete",
		'data':{name:btnvalue},
		'success':function(data){	
		if(data=="YES"){
			alert("error");
...
<div class="header_slide">
 ...
 <div class="main">
    <div class="content">
    	<div class="content_top" style="margin-top:550px;">
    		<div class="heading">
    		<h3>New Products</h3>
    		</div>
    		<div class="see">
