...
function fun2(){
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/viewtblsub",
		'datatype':"json",
		'data':{name:vall},
		'success':function(data){
...
function edit(subclick)
{
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/editsub",
		'datatype':"json",
		'data':{name:subclick },
		'success':function(data){
...
function del(btnvalue)
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/deletesubcategory",
		'data':{name:btnvalue},
		'success':function(data){	
		if(data=="YES"){
			alert("error");
