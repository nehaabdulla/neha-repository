...
function purchasedetails(id)
{
	$.ajax({
		'type' :"POST",
		'url' :"http://api.baabtra.com/homeshop_services/index.php/welcome/detailofproducts",
		'datatype':"json",
		'data':{name:id},
	  	     	...
	  	     	<div class="container" style="padding:15px;">
	  	     		<div class="row" id="div1">
						...
						<?php
							...
							{
								echo"<tr>";
								echo "<td>".$row->pk_int_reg_id."</td><td>".$row->vchr_fname." </td><td>".$row->vchr_lname."</td><td>".$row->vchr_address."</td><td>".$row->vchr_mobile."</td><td>".$row->dat_date."</td>";
